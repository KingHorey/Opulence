...
import { DecreaseSvg, IncreaseSvg, LoadingAnimation, WhiteCartIcon } from '../../components/svg'
...
import { addtoCart,decreaseAmount,increaseAmount, removeItem } from '../../stateManagement/features/CartSlice'

export function ProductDetails() {
  const {cartItems,numItemsInCart,cartTotal} = useAppSelector((state)=>state.cart)
